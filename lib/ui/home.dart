...
class _HomePageState extends State<HomePage> {
  ...
  void onTextChange(String text) {
    if (text.isNotEmpty) {
      translator.translate(text, to: "$_transalateLanguage").then((value) {
        setState(() {
          out = value.toString();
        });
      });
  ...
  return Scaffold(
        ...
        Padding(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton(
              ...
              style: TextStyle(fontFamily: 'PoppinsReg', color: Colors.black),
              onChanged: (value) {
                if (value != null) {
                  setState(() {
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: Color(0xFF121212), // Black color for input box
                  ),
                  child: TextField(
                    onChanged: onTextChange, // Translate on text change
                    controller: lang,
                    minLines: 5,
                    maxLines: 999,
                    ...
                    style: TextStyle(
                        fontFamily: 'PoppinsReg', fontSize: 14, color: Colors.white),
                  ),
                ),
              ),
            ),
            Expanded(
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10.0),
                    color: Colors.grey[400], // Grey color for output box
                  ),
                  child: Padding(
    ...
    Padding(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                trans(); // Call the trans method to set the translation language
                onTextChange(lang.text); // Translate the input text
              },
              child: Text(
                "Translate",
                style: TextStyle(
